...
There are two options either upload a profile picture or remove whatever there is if clicked on no-profile the default profile-picture will be set there
